...
public class Cd_7_copy {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n");
        System.out.println("-----------------------------");
        System.out.println("Result\tOp1.\tOpr.\tOp2.");
        System.out.println("-----------------------------");
        for(int i=0;i<line;i++)
        {
            if(inobj[i].operator!='n')
                System.out.println(inobj[i].result+"\t"+inobj[i].op1+"\t"+inobj[i].operator+"\t"+inobj[i].op2);
            else    
                System.out.println(inobj[i].result+"\t"+inobj[i].op1+"\t"+"null"+"\t"+inobj[i].op2);
        }
        System.out.println("-----------------------------");
        
        
        CF(); // First pass Replace
        CP();
        
        CF(); // Second Pass replace
        CP();

        CF(); // Third Pass only CF
